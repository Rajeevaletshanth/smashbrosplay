...
const SquadBanner = ({title = 'Tournaments', description = 'Experience the perfect blend of fun and competition with exciting matches and unforgettable moments'}:any) => {
  const [isOpen, setOpen] = useState(false);
  return (
    <>
      <section className="squad-banner-seven">
