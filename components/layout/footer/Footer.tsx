...
import ThumbOne from "public/images/shuttle.png";
import ThumbTwo from "public/images/shuttle.png";
          ...
          <div className="col-12 col-md-9 col-lg-9 col-xl-10 col-xxl-9">
            <div className="footer__content text-center">
              <h2 className="light-title fw-7 title-animation">
                Experience the fun with <span>SmashBros.</span>
              </h2>
                ...
                <div className="col-12 col-lg-4">
                  <div className="footer__nav-logo text-center text-lg-start">
                    <Link href="/" aria-label="home page" title="logo">
                      <Image src={Logo} alt="Image" priority width={150}/>
                    </Link>
                  </div>
                </div>
