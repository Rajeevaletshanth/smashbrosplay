        ...
        <div className="offcanvas-info__inner">
          <div className="offcanvas-info__intro">
            <div className="offcanvas-info__logo">
              <Link href="/">
                <Image src={logo} alt="Image" priority width={220}/>
              </Link>
            </div>
            {/* <h4>Smash the limits</h4> */}
          </div>
          <div className="offcanvas-info__content">
            <h5>Contact Us</h5>
            <ul>
              <li>
                <Link href="mailto:Aikeu@example.com">smashbros.lk</Link>
              </li>
              <li>
                <Link href="tel:1880-480-555-0103">+94 713080226</Link>
              </li>
              {/* <li>
                <Link
